...
import useProductCategory from "./useProductCat";
import "./homePage.css";
...
const MyHome = () => {
  ...
  const { addToCart, theme, title, cart } = useContext(GlobalContext);
  ...
  return (
    <div className="home" data-theme={theme}>
      ...
      <div className="product_type">
        <div className="container">
          <ProductSection title="New Product" products={newProduct} addToCart={addToCart} />
          <ProductSection title="Featured Product" products={featuredProduct} addToCart={addToCart} />
          <ProductSection title="Top Product" products={topProduct} addToCart={addToCart} />
        </div>
      </div>
